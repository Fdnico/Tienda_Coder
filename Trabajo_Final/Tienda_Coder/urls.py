...
urlpatterns = [
    ...
    path('Tienda_Coder/periferico_ver/<id>/', Ver_Periferico, name='periferico_ver'),
    ...
    path('Tienda_Coder/consola_ver/<id>/', Ver_Consola, name='consola_ver'),
    ...
    path('Tienda_Coder/juego_ver/<id>/', Ver_Juego, name='juego_ver'),
